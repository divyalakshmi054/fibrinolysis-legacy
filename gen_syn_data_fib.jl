...
path_to_experimental_data = joinpath(_PATH_TO_DATA, "Synthetic-Numerical-CoV-10K-Fibrinolysis.csv")
...
path_to_transformed_data = joinpath(_PATH_TO_DATA, "Training-Synthetic-10K-CoV-Fibrinolysis.csv")
